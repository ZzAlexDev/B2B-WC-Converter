...
WC_ATTRIBUTES = {
    # Основные атрибуты из задачи
    'Вариант размещения': 'pa_placement',  # ← ДОБАВЛЯЕМ!
    'Область применения': 'pa_application',
    'Гарантийный срок': 'pa_warranty',
    'Цвет корпуса': 'pa_color',
    'Страна производства': 'pa_country',
    'Макс. потребляемая мощность': 'pa_power',
    'Масса товара (нетто)': 'pa_weight',
    'Ширина товара': 'pa_width',
    'Глубина товара': 'pa_depth',
    'Высота товара': 'pa_height',
    'Срок службы': 'pa_lifetime',
    
    # Дополнительные атрибуты (часто встречаются)
    'Материал корпуса': 'pa_material',
    'Тип термостата': 'pa_thermostat',
    'Класс пылевлагозащищенности': 'pa_ip_rating',
    'Тип нагревательного элемента': 'pa_heating_element',
    'Вид управления': 'pa_control_type',
    'Вид установки (крепления)': 'pa_installation_type',
    'Серия': 'pa_series',
    
    # Для совместимости (старые названия)
    'Тип установки': 'pa_installation_type',
